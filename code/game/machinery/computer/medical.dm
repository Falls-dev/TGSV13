...
<th>Mental Status</th>
				...
				if(4)
					...
					if(active1 in GLOB.data_core.general)
						...
						dat += "<tr><td>Sex:</td><td><A href='byond://?src=[REF(src)];field=sex'>&nbsp;[active1.fields["sex"]]&nbsp;</A></td></tr>" //NSV13
						...
						dat += "<tr><td>General Records:</td><td><A href='byond://?src=[REF(src)];choice=View Past General'>View&nbsp;</A></td></tr>" //NSV13 - Roleplaying Records
					else
						dat += "<tr><td>General Record Lost!</td></tr>"

					dat += "<tr><td><br><b><font size='4'>Medical Data</font></b></td></tr>"
					if(active2 in GLOB.data_core.medical)
						dat += "<tr><td>Medical Records:</td><td><A href='byond://?src=[REF(src)];choice=View Past Medical'>View&nbsp;</A></td></tr>" //NSV13 - Roleplaying Records
